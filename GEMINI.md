...
This is a full-stack service booking platform for a marketing company called "[companyname]". It allows customers to browse services, book appointments, and manage their bookings. The application includes an admin dashboard for managing services, bookings, and company settings. It also integrates with GoHighLevel CRM.
