...
import { getServicePath } from "@/lib/service-path";
...
export function ServiceCard({ service }: ServiceCardProps) {
  return (
    <Link href={getServicePath(service)} className="group bg-light-gray rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full">
