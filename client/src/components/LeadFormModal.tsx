                ...
                {view === "form" && currentQuestion && (
                  <form onSubmit={handleSubmit}>
                    <div className="flex items-start justify-between">
                      <div>
                        <p className="text-sm font-semibold text-cta uppercase tracking-wide">Let's get started!</p>
                    ...
                    <div className="mt-8 flex items-center justify-between gap-3">
                      ...
                      <button
                        ...
                        className={clsx(
                          "inline-flex items-center justify-center gap-2 rounded-xl bg-cta px-6 py-3 text-white font-semibold hover:bg-cta-hover transition-colors flex-1",
